...
# Flags to be used by chromium-x11 recipe, when it switches to m72.
...
# Patches to be used be chromium-x11 recipe, when it switches to m72.
SRC_URI += " \
        file://m72/0001-Add-missing-limits-header-to-crashpad.patch \
        file://m72/0001-Add-missing-algorithm-header-to-webcursor_ozone.patch \
"
